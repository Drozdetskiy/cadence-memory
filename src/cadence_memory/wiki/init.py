...
_FILE_MAP: tuple[tuple[str, str], ...] = (
    ...
    (".claude/skills/wiki-researcher/SKILL.md", ".claude/skills/wiki-researcher/SKILL.md"),
    (".claude/skills/wiki-ingest/SKILL.md", ".claude/skills/wiki-ingest/SKILL.md"),
    (".claude/skills/wiki-research/SKILL.md", ".claude/skills/wiki-research/SKILL.md"),
    (".claude/skills/wiki-sync/SKILL.md", ".claude/skills/wiki-sync/SKILL.md"),
    (".claude/skills/wiki-synthesize/SKILL.md", ".claude/skills/wiki-synthesize/SKILL.md"),
    (".claude/skills/wiki-distill/SKILL.md", ".claude/skills/wiki-distill/SKILL.md"),
    ("gitignore", ".gitignore"),
